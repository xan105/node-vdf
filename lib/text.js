...
https://github.com/rossengeorgiev/vdf-parser/tree/0d210ec51a2be4d6186777addf8f98df59f9eb53
*/
  ...
  for (let i = 0; i < lines.length; i++)
  {
    ...
    while (!parsed) 
    {
      ...
      if (typeof val === "undefined" || 
          val.startsWith("//") //inline comment next to key name |to do: handle this in that horrendous magic regex
      ) {
        //New map
